...
cp -f Arrowhead_Core_Spring/serviceregistry/target/*.jar jenkins/build/serviceregistry
...
cp -f Arrowhead_Core_Spring/authorization/target/*.jar jenkins/build/authorization
...
cp -f Arrowhead_Core_Spring/orchestrator/target/*.jar jenkins/build/orchestrator
...
cp -f Arrowhead_Core_Spring/gatekeeper/target/*.jar jenkins/build/gatekeeper
...
cp -f Arrowhead_Core_Spring/gateway/target/*.jar jenkins/build/gateway
...
cp -f Arrowhead_Core_Spring/eventhandler/target/*.jar jenkins/build/eventhandler
